...
function Footer() {
  return (
    <div className='z-0  text-white  '>
      <footer className="footer bg-black rounded-t-md  p-24 text-base font-semibold">
  <div>
...
<footer className="footer px-10 py-4 border-t border-t-primary bg-black text-white border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>PI Learning Ltd. <br/>Providing reliable tech since 2016</p>
  </div> 

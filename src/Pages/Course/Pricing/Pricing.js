  ...
  const toggleClass = " transform translate-x-5";
    return (
        ...
        <li className='inline-block '>  <button  onClick={() => {
            setToggle(!toggle);
          }} className="px-4 py-1 text-sm font-semibold rounded-full w-full transition-all duration-500 ease-in-out hover:text-white dark:hover:text-white hover:bg-indigo-600 dark:hover:bg-slate-800 " >
            Monthly Plan
          </button></li>
        <li className='inline-block'>
        <button  className={"px-4 py-1 text-sm font-semibold rounded-full w-full transition-all duration-500 ease-in-out hover:text-white dark:hover:text-white hover:bg-indigo-600 dark:hover:bg-slate-800" +
